				...
				while (true) {
					...
					switch (step) {
						...
						case 0:
							...
							// 3. Operat�ren indtaster operat�r nr.
							// 4. V�gten svarer tilbage med operat�rnavn som s� godkendes
						...
						case 1:
							...
							// 5. Operat�ren indtaster produktbatch nummer
						...
						case 2:
							...
							// 7. Operat�ren kontrollerer at v�gten er ubelastet og trykker �ok�
							// 8. V�gten tareres
							// 9. V�gten beder om f�rste tara beholder
							// 10. Operat�r placerer f�rste tarabeholder og trykker �ok�
							// 11. V�gten af tarabeholder registreres
							// 12. V�gten tareres
						...
						case 3:
							...
							// 13. V�gten beder om raavarebatch nummer p� f�rste r�vare
						...
						case 4:
							...
							// 14. Operat�ren afvejer op til den �nskede m�ngde og trykker �ok�
						...
						case 5:
							...
							// 15. Pkt. 7 � 14 gentages indtil alle r�varer er afvejet
						...
						case 6:
							...
							// 16. Systemet s�tter produktbatch nummerets status til �Afsluttet�
						...
						default:
							...
							// 17. Det kan herefter genoptages af en ny operat�r
							step = 0;
